...
public final class Speech {
  ...
  public enum Equalizer
    ...
    public static final com.google.protobuf.Descriptors.EnumDescriptor
        getDescriptor() {
      return is.hello.speech.core.api.Speech.getDescriptor().getEnumTypes().get(0);
    }
  ...
  public enum AudioFormat
    ...
    public static final com.google.protobuf.Descriptors.EnumDescriptor
        getDescriptor() {
      return is.hello.speech.core.api.Speech.getDescriptor().getEnumTypes().get(1);
    }
  ...
  public enum Keyword
    ...
    public static final com.google.protobuf.Descriptors.EnumDescriptor
        getDescriptor() {
      return is.hello.speech.core.api.Speech.getDescriptor().getEnumTypes().get(2);
    }
  ...
  public interface SpeechRequestOrBuilder extends
     ...
     * <code>optional .speech.Keyword word = 1;</code>
     */
    is.hello.speech.core.api.Speech.Keyword getWord();
     ...
     * <code>optional .speech.Equalizer eq = 4 [default = SENSE_ONE];</code>
     */
    is.hello.speech.core.api.Speech.Equalizer getEq();
     ...
     * <code>optional .speech.AudioFormat response = 5 [default = MP3];</code>
     */
    is.hello.speech.core.api.Speech.AudioFormat getResponse();
  ...
  public static final class SpeechRequest extends
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 8: {
              ...
              is.hello.speech.core.api.Speech.Keyword value = is.hello.speech.core.api.Speech.Keyword.valueOf(rawValue);
              if (value == null) {
            ...
            case 32: {
              int rawValue = input.readEnum();
              is.hello.speech.core.api.Speech.Equalizer value = is.hello.speech.core.api.Speech.Equalizer.valueOf(rawValue);
              if (value == null) {
            ...
            case 40: {
              int rawValue = input.readEnum();
              is.hello.speech.core.api.Speech.AudioFormat value = is.hello.speech.core.api.Speech.AudioFormat.valueOf(rawValue);
              if (value == null) {
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return is.hello.speech.core.api.Speech.internal_static_speech_SpeechRequest_descriptor;
    }

    protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return is.hello.speech.core.api.Speech.internal_static_speech_SpeechRequest_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              is.hello.speech.core.api.Speech.SpeechRequest.class, is.hello.speech.core.api.Speech.SpeechRequest.Builder.class);
    }
    ...
    private is.hello.speech.core.api.Speech.Keyword word_;
    /**
     * <code>optional .speech.Keyword word = 1;</code>
     */
     ...
     * <code>optional .speech.Keyword word = 1;</code>
     */
    public is.hello.speech.core.api.Speech.Keyword getWord() {
      return word_;
    }
    ...
    private is.hello.speech.core.api.Speech.Equalizer eq_;
    /**
     * <code>optional .speech.Equalizer eq = 4 [default = SENSE_ONE];</code>
     */
     ...
     * <code>optional .speech.Equalizer eq = 4 [default = SENSE_ONE];</code>
     */
    public is.hello.speech.core.api.Speech.Equalizer getEq() {
      return eq_;
    }

    public static final int RESPONSE_FIELD_NUMBER = 5;
    private is.hello.speech.core.api.Speech.AudioFormat response_;
    /**
     * <code>optional .speech.AudioFormat response = 5 [default = MP3];</code>
     */
     ...
     * <code>optional .speech.AudioFormat response = 5 [default = MP3];</code>
     */
    public is.hello.speech.core.api.Speech.AudioFormat getResponse() {
      return response_;
    }
    ...
    private void initFields() {
      word_ = is.hello.speech.core.api.Speech.Keyword.NULL;
      confidence_ = 0;
      version_ = 0;
      eq_ = is.hello.speech.core.api.Speech.Equalizer.SENSE_ONE;
      response_ = is.hello.speech.core.api.Speech.AudioFormat.MP3;
      samplingRate_ = 16000;
    }
    ...
    public static is.hello.speech.core.api.Speech.SpeechRequest parseFrom(
    ...
    public static is.hello.speech.core.api.Speech.SpeechRequest parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static is.hello.speech.core.api.Speech.SpeechRequest parseFrom(
    ...
    public static is.hello.speech.core.api.Speech.SpeechRequest parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static is.hello.speech.core.api.Speech.SpeechRequest parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return PARSER.parseDelimitedFrom(input);
    }
    public static is.hello.speech.core.api.Speech.SpeechRequest parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
    ...
    public static Builder newBuilder(is.hello.speech.core.api.Speech.SpeechRequest prototype) {
    ...
    public static final class Builder extends
        ...
        is.hello.speech.core.api.Speech.SpeechRequestOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return is.hello.speech.core.api.Speech.internal_static_speech_SpeechRequest_descriptor;
      }
      ...
      // Construct using is.hello.speech.core.api.Speech.SpeechRequest.newBuilder()
      private Builder() {
      ...
      public is.hello.speech.core.api.Speech.SpeechRequest getDefaultInstanceForType() {
        return is.hello.speech.core.api.Speech.SpeechRequest.getDefaultInstance();
      }

      public is.hello.speech.core.api.Speech.SpeechRequest build() {
        is.hello.speech.core.api.Speech.SpeechRequest result = buildPartial();
      ...
      public is.hello.speech.core.api.Speech.SpeechRequest buildPartial() {
        is.hello.speech.core.api.Speech.SpeechRequest result = new is.hello.speech.core.api.Speech.SpeechRequest(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof is.hello.speech.core.api.Speech.SpeechRequest) {
          return mergeFrom((is.hello.speech.core.api.Speech.SpeechRequest)other);
        } else {
      ...
      public Builder mergeFrom(is.hello.speech.core.api.Speech.SpeechRequest other) {
        if (other == is.hello.speech.core.api.Speech.SpeechRequest.getDefaultInstance()) return this;
        if (other.hasWord()) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        is.hello.speech.core.api.Speech.SpeechRequest parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (is.hello.speech.core.api.Speech.SpeechRequest) e.getUnfinishedMessage();
          throw e;
        } finally {
      ...
      private is.hello.speech.core.api.Speech.Keyword word_ = is.hello.speech.core.api.Speech.Keyword.NULL;
      /**
       * <code>optional .speech.Keyword word = 1;</code>
       */
      public boolean hasWord() {
       ...
       * <code>optional .speech.Keyword word = 1;</code>
       */
      public Builder setWord(is.hello.speech.core.api.Speech.Keyword value) {
        if (value == null) {
      ...
      private is.hello.speech.core.api.Speech.Equalizer eq_ = is.hello.speech.core.api.Speech.Equalizer.SENSE_ONE;
      /**
       * <code>optional .speech.Equalizer eq = 4 [default = SENSE_ONE];</code>
       */
      public boolean hasEq() {
       ...
       * <code>optional .speech.Equalizer eq = 4 [default = SENSE_ONE];</code>
       */
      public Builder setEq(is.hello.speech.core.api.Speech.Equalizer value) {
        if (value == null) {
          throw new NullPointerException();
        }
        bitField0_ |= 0x00000008;
      ...
      private is.hello.speech.core.api.Speech.AudioFormat response_ = is.hello.speech.core.api.Speech.AudioFormat.MP3;
      /**
       * <code>optional .speech.AudioFormat response = 5 [default = MP3];</code>
       */
      public boolean hasResponse() {
       ...
       * <code>optional .speech.AudioFormat response = 5 [default = MP3];</code>
       */
      public Builder setResponse(is.hello.speech.core.api.Speech.AudioFormat value) {
        if (value == null) {
          throw new NullPointerException();
        }
        bitField0_ |= 0x00000010;
