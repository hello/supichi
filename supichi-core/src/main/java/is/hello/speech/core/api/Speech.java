...
public final class Speech {
  ...
  public static final class speech_data extends
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 8: {
              ...
              Speech.keyword value = Speech.keyword.valueOf(rawValue);
              if (value == null) {
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return Speech.internal_static_speech_data_descriptor;
    }

    protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return Speech.internal_static_speech_data_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              Speech.speech_data.class, Speech.speech_data.Builder.class);
    }
    ...
    public static Speech.speech_data parseFrom(
    ...
    public static Speech.speech_data parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static Speech.speech_data parseFrom(
    ...
    public static Speech.speech_data parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static Speech.speech_data parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return PARSER.parseDelimitedFrom(input);
    }
    public static Speech.speech_data parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
    ...
    public static Builder newBuilder(Speech.speech_data prototype) {
    ...
    public static final class Builder extends
       ...
       implements Speech.speech_dataOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return Speech.internal_static_speech_data_descriptor;
      }
      ...
      // Construct using Speech.speech_data.newBuilder()
      private Builder() {
      ...
      public Speech.speech_data getDefaultInstanceForType() {
        return Speech.speech_data.getDefaultInstance();
      }

      public Speech.speech_data build() {
        Speech.speech_data result = buildPartial();
      ...
      public Speech.speech_data buildPartial() {
        Speech.speech_data result = new Speech.speech_data(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof Speech.speech_data) {
          return mergeFrom((Speech.speech_data)other);
        } else {
      ...
      public Builder mergeFrom(Speech.speech_data other) {
        if (other == Speech.speech_data.getDefaultInstance()) return this;
        if (other.hasWord()) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        Speech.speech_data parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (Speech.speech_data) e.getUnfinishedMessage();
          throw e;
        } finally {
      ...
      // optional .keyword word = 1;
      private Speech.keyword word_ = Speech.keyword.NULL;
      /**
       * <code>optional .keyword word = 1;</code>
       */
      public boolean hasWord() {
       ...
       * <code>optional .keyword word = 1;</code>
       */
      public Builder setWord(Speech.keyword value) {
        if (value == null) {
